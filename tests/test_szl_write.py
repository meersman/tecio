...
def test_write_ijk_unsteady() -> None:
    ...
    try:
        ...
        with szl.Write("test_szl_write_ijk_unsteady.szplt") as writer:
...
def test_write_fe_cells() -> None:
    ...
    offset = 2
    try:
        with szl.Write("test_szl_write_fe_cells.szplt") as writer:
...
def test_write_fe_array_length_mismatch() -> None:
    ...
    try:
        ...
        with szl.Write(
            "test_szl_write_fe_len_mismatch.szplt", title="fe_len_test"
        ) as writer:
            writer.write_fe_zone(
                zone_type=ZoneType.FETRIANGLE,
                data=[x_short, y],
...
def test_write_fe_unsupported_zone_type() -> None:
    ...
    try:
        ...
        with szl.Write(
            "test_szl_write_fe_polygon.szplt", title="fe_polygon_test"
        ) as writer:
            writer.write_fe_zone(
