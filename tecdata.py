...
class TecData:
    ...
    def from_szl_file(
        ...
        var_indices = variables if variables is not None else list(range(1, szl.num_vars + 1))
        
        # Load variable metadata
        for var_idx in var_indices:
            var_name = szl.zones[0].variables[var_idx - 1].name  # All zones share var names
    ...
    def add_variable(self, name: str, location: ValueLocation = ValueLocation.NODAL) -> int:
        """
