r"""
:mod:`dat`: Tecplot ASCII DAT file reader and writer
=====================================================
...
def _unquote(s: str) -> str:
    """Remove surrounding double-quotes and unescape internal ``\\"``.
...
class Write:
    ...
    def flush_aux(self) -> None:
        ...
        """
        if self._fp is None:
            raise IOError("flush_aux() called before the file was opened.")
